...
\subsection{Justification des données
simulées}\label{justification-des-donnuxe9es-simuluxe9es}

\textbf{Situation de disponibilité :} Au moment de ce travail, les
microdonnées infra-nationales sénégalaises ne sont pas toutes
accessibles gratuitement. Le RGPH 2023 n'a été publié que partiellement,
et les données de l'EHCVM sont sous accès restreint pour les
microdonnées régionales désagrégées.

\textbf{Garanties de réalisme :} Les données du présent rapport sont
simulées à partir des ordres de grandeur réels disponibles dans les
rapports ANSD accessibles au public, avec les propriétés suivantes :

\begin{itemize}
\tightlist
\item
  Les \textbf{écarts entre régions} respectent le gradient
  Nord-Ouest/Sud-Est documenté dans la littérature
\item
  \textbf{Dakar} affiche les meilleures performances sur tous les
  indicateurs urbains
\item
  \textbf{Kédougou, Sédhiou et Kolda} sont systématiquement en bas de
  classement, conformément aux données officielles
\item
  La simulation est \textbf{reproductible} : le fichier
  \texttt{donnees\_regions.csv} est versionné dans le dépôt GitHub
\end{itemize}

\textbf{Implication méthodologique :} L'objectif de ce TP est de tester
une \emph{méthode}, pas de produire des statistiques officielles. La
robustesse de l'indice et la méthodologie restent entièrement valides
avec des données simulées réalistes.
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-audit-cv-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-corr-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-norm-impact-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-scree-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-biplot-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-profil-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-sensib-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{../figures/rapport-classement-1} 
